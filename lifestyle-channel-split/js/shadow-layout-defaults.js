...
(function(){
  ...
  var CENTER_WITH_PRODUCT = 0.41; // B：整組偏左，右側留給商品
  ...
  window.ShadowLayoutDefaults = {
    ...
    B: {
      ...
      product1: { xPct: 0.76, yPct: 0.58, hPct: 0.28 } // 右側，跟臉同高，靠近人物
    },
    ...
    C: {
      ...
      product2: { xPct: 0.74, yPct: 0.70, hPct: 0.28 }  // 偏右下，疊在商品1前面
    },
    ...
    D: {
      ...
      product2: { xPct: 0.74, yPct: 0.70, hPct: 0.28 }, // 偏右下，跟C組合商品2同位置
